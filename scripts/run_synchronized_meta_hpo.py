...
def main():
 ...
 import wandb; wr=None if a.no_wandb else wandb.init(project=a.wandb_project,name=a.wandb_run_name,config={"protocol":"synchronized_four_dataset_hpo_benchmark_meta_selection","train_datasets":datasets,"meta_train_datasets":train_ids,"meta_validation_dataset":valid_id,"target_dataset":alz,"n_trials":a.n_trials})
